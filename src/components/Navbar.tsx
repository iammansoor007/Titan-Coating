    ...
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled
          ? "bg-[#111111]/90 backdrop-blur-xl shadow-lg py-2 border-b border-primary/20"
          : "bg-transparent py-2"
          }`}
      >
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-full max-w-md bg-[#111111] z-50 lg:hidden shadow-2xl border-l border-primary/20 overflow-hidden"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-t border-primary/20 bg-[#1A1A1A] flex-shrink-0">
                  <div className="space-y-4">
                    <a
                      href="#quote"
                      onClick={() => setIsMenuOpen(false)}
                      className="block w-full py-4 bg-gradient-to-r from-primary to-secondary text-[#111111] font-bold rounded-xl text-center shadow-lg shadow-primary/20 transition-all duration-300 active:scale-[0.98]"
                    >
                      Get Free Quote Now
                    </a>
                  </div>
