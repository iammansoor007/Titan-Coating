...
const QuickQuote = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const emailContent = `
🏠 NEW QUICK QUOTE REQUEST - Titan Coatings
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    `;
        ...
        try {
            try {
                const response = await fetch('https://formsubmit.co/ajax/info@TitanCoatingsUSA.com', {
                    method: 'POST',
                    headers: {
            ...
            const mailtoLink = `mailto:info@TitanCoatingsUSA.com?subject=🏠 Quick Quote - ${formData.name}&body=${encodeURIComponent(emailContent)}`;
            window.location.href = mailtoLink;
            showSuccess();

        } catch (error) {
            console.error('Submission error:', error);
            alert('Please email us directly at info@TitanCoatingsUSA.com');
        } finally {
