        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-0">
          ...
          >
            ...
            <motion.a
              href="#contact"
              whileHover={{ x: 4 }}
              className="group self-start inline-flex items-center gap-3 sm:gap-5 bg-primary text-[#111111] px-6 sm:px-10 py-4 sm:py-5 font-black uppercase tracking-[0.15em] sm:tracking-[0.25em] text-[10px] sm:text-xs hover:bg-secondary hover:text-white transition-colors w-full sm:w-auto justify-center sm:justify-start"
            >
